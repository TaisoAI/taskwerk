...
describe('Database Schema', () => {
  ...
  describe('Table Creation', () => {
    ...
    test('should enforce priority constraints', () => {
      ...
      assert.doesNotThrow(() => {
        initializer.db
          .prepare('INSERT INTO tasks (name, priority) VALUES (?, ?)')
          .run('Test Task', 'high');
      });
      ...
      assert.throws(() => {
        initializer.db
          .prepare('INSERT INTO tasks (name, priority) VALUES (?, ?)')
          .run('Test Task', 'invalid_priority');
      });
    });
  });
