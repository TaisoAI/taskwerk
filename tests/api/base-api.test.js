...
describe('Base API Layer', () => {
  ...
  describe('Data Sanitization', () => {
    test('should remove undefined fields', () => {
      ...
      assert.ok(!Object.prototype.hasOwnProperty.call(sanitized, 'description'));
    });
  ...
  describe('Health Check', () => {
    ...
    test('should handle database errors in health check', async () => {
      // Initialize first to create a valid database
      await api.initialize();
      ...
      api.dbInitializer.dbPath = '/dev/null/cannot-create-db-here.db';
